          ...
          (progn
            (let* ((progress (get-goal-progress))
                   (ecosystem-health (if (fboundp 'calculate-ecosystem-health)
                                         ...
                                         0))
                   (last-guardian-heartbeat (if (boundp 'swimmy.globals::*last-guardian-heartbeat*)
                                                swimmy.globals::*last-guardian-heartbeat*
                                                0))
                   (tick-age (if (> last-guardian-heartbeat 0)
                                 (- now last-guardian-heartbeat)
                                 0))
                   ...
                   (payload `((schema_version . 2)
                              ...
                              (last_guardian_heartbeat . ,last-guardian-heartbeat)
                              (tick_age_secs . ,tick-age)

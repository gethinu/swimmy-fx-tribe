...
//| Original: Bred-Bred--458-Gen32-N3980040289-704                  |
//+------------------------------------------------------------------+
#property strict
#property version   "1.00"
#property description "Historical S batch-3: Bred-Bred--458-Gen32-N3980040289-704"
...
input ulong            InpMagic = 9307508;
input int              InpSlippagePoints = 30;
input double           InpStopLossPrice = 1.03122413;
input double           InpTakeProfitPrice = 0.93223095;
...
bool OpenManagedPosition(const bool is_buy) {
   ...
   if(is_buy) return g_trade.Buy(InpLots, symbol, 0.0, sl, tp, "Bred-Bred--458-Gen32-N3980040289-704");
   return g_trade.Sell(InpLots, symbol, 0.0, sl, tp, "Bred-Bred--458-Gen32-N3980040289-704");
}

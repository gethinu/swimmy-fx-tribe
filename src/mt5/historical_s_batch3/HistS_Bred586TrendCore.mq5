...
//| Original: Bred-Bred--586-Gen29-N3980038495-317                  |
//+------------------------------------------------------------------+
#property strict
#property version   "1.00"
#property description "Historical S batch-3: Bred-Bred--586-Gen29-N3980038495-317"
...
input ulong            InpMagic = 9307507;
input int              InpSlippagePoints = 30;
input double           InpStopLossPrice = 1.23829138;
input double           InpTakeProfitPrice = 0.67344964;
...
bool OpenManagedPosition(const bool is_buy) {
   ...
   if(is_buy) return g_trade.Buy(InpLots, symbol, 0.0, sl, tp, "Bred-Bred--586-Gen29-N3980038495-317");
   return g_trade.Sell(InpLots, symbol, 0.0, sl, tp, "Bred-Bred--586-Gen29-N3980038495-317");
}

...
//| Original: Bred-Bred--940-Gen31-N3980039835-605                  |
//+------------------------------------------------------------------+
#property strict
#property version   "1.00"
#property description "Historical S batch-3: Bred-Bred--940-Gen31-N3980039835-605"
...
input ulong            InpMagic = 9307506;
input int              InpSlippagePoints = 30;
input double           InpStopLossPrice = 1.71180403;
input double           InpTakeProfitPrice = 0.87598586;
...
bool OpenManagedPosition(const bool is_buy) {
   ...
   if(is_buy) return g_trade.Buy(InpLots, symbol, 0.0, sl, tp, "Bred-Bred--940-Gen31-N3980039835-605");
   return g_trade.Sell(InpLots, symbol, 0.0, sl, tp, "Bred-Bred--940-Gen31-N3980039835-605");
}

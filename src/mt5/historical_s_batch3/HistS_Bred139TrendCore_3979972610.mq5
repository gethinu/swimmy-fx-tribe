...
//| Original: Bred-Bred--139-Gen11-N3979972610-6                    |
//+------------------------------------------------------------------+
#property strict
#property version   "1.00"
#property description "Historical S batch-3: Bred-Bred--139-Gen11-N3979972610-6"
...
input ulong            InpMagic = 9307510;
input int              InpSlippagePoints = 30;
input double           InpStopLossPrice = 0.80311793;
input double           InpTakeProfitPrice = 0.68440109;
...
bool OpenManagedPosition(const bool is_buy) {
   ...
   if(is_buy) return g_trade.Buy(InpLots, symbol, 0.0, sl, tp, "Bred-Bred--139-Gen11-N3979972610-6");
   return g_trade.Sell(InpLots, symbol, 0.0, sl, tp, "Bred-Bred--139-Gen11-N3979972610-6");
}

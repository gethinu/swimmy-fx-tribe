...
//| Original: Bred-Bred--187-Gen23-N3980038264-261                  |
//+------------------------------------------------------------------+
#property strict
#property version   "1.00"
#property description "Historical S batch-3: Bred-Bred--187-Gen23-N3980038264-261"
...
input ulong            InpMagic = 9307504;
input int              InpSlippagePoints = 30;
input double           InpStopLossPrice = 0.79124993;
input double           InpTakeProfitPrice = 0.65910667;
...
bool OpenManagedPosition(const bool is_buy) {
   ...
   if(is_buy) return g_trade.Buy(InpLots, symbol, 0.0, sl, tp, "Bred-Bred--187-Gen23-N3980038264-261");
   return g_trade.Sell(InpLots, symbol, 0.0, sl, tp, "Bred-Bred--187-Gen23-N3980038264-261");
}

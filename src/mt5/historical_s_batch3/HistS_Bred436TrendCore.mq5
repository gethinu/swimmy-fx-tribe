...
//|               Historical S extraction batch-3 port               |
//| Original: Bred-Bred--436-Gen32-N3980040463-744                  |
//+------------------------------------------------------------------+
#property strict
#property version   "1.00"
#property description "Historical S batch-3: Bred-Bred--436-Gen32-N3980040463-744"
...
input ulong            InpMagic = 9307505;
input int              InpSlippagePoints = 30;
input double           InpStopLossPrice = 0.79656851;
input double           InpTakeProfitPrice = 0.73078024;
...
bool OpenManagedPosition(const bool is_buy) {
   ...
   if(is_buy) return g_trade.Buy(InpLots, symbol, 0.0, sl, tp, "Bred-Bred--436-Gen32-N3980040463-744");
   return g_trade.Sell(InpLots, symbol, 0.0, sl, tp, "Bred-Bred--436-Gen32-N3980040463-744");
}

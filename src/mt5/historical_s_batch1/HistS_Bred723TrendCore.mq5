...
//| Original: Bred-Bred--723-Gen29-N3980038311-278                  |
//+------------------------------------------------------------------+
#property strict
#property version   "1.00"
#property description "Historical S batch-1: Bred-Bred--723-Gen29-N3980038311-278"
...
input ulong            InpMagic = 9307402;
input int              InpSlippagePoints = 30;
input double           InpStopLossPrice = 0.76192120;
input double           InpTakeProfitPrice = 0.84355370;
...
bool OpenManagedPosition(const bool is_buy) {
   ...
   if(is_buy) return g_trade.Buy(InpLots, symbol, 0.0, sl, tp, "Bred-Bred--723-Gen29-N3980038311-278");
   return g_trade.Sell(InpLots, symbol, 0.0, sl, tp, "Bred-Bred--723-Gen29-N3980038311-278");
}

...
//| Original: Bred-Bred--508-Gen32-N3980040829-808                  |
//+------------------------------------------------------------------+
#property strict
#property version   "1.00"
#property description "Historical S batch-2: Bred-Bred--508-Gen32-N3980040829-808"
...
input ulong            InpMagic = 9307501;
input int              InpSlippagePoints = 30;
input double           InpStopLossPrice = 0.79337865;
input double           InpTakeProfitPrice = 0.76341116;
...
bool OpenManagedPosition(const bool is_buy) {
   ...
   if(is_buy) return g_trade.Buy(InpLots, symbol, 0.0, sl, tp, "Bred-Bred--508-Gen32-N3980040829-808");
   return g_trade.Sell(InpLots, symbol, 0.0, sl, tp, "Bred-Bred--508-Gen32-N3980040829-808");
}

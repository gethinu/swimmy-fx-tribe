...
//| Original: Bred-Bred--128-Gen28-N3980038170-239                  |
//+------------------------------------------------------------------+
#property strict
#property version   "1.00"
#property description "Historical S batch-2: Bred-Bred--128-Gen28-N3980038170-239"
...
input ulong            InpMagic = 9307503;
input int              InpSlippagePoints = 30;
input double           InpStopLossPrice = 1.39970744;
input double           InpTakeProfitPrice = 0.49270576;
...
bool OpenManagedPosition(const bool is_buy) {
   ...
   if(is_buy) return g_trade.Buy(InpLots, symbol, 0.0, sl, tp, "Bred-Bred--128-Gen28-N3980038170-239");
   return g_trade.Sell(InpLots, symbol, 0.0, sl, tp, "Bred-Bred--128-Gen28-N3980038170-239");
}
